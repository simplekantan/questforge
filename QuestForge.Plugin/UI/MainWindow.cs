...
public sealed class MainWindow : Window
{
    ...
    public MainWindow(EngineHost host, IQuestScheduler scheduler, PluginConfig config, IDalamudPluginInterface pi)
    ...
    private void DrawSettings()
    {
        ...
        if (ImGui.Checkbox("Enable Tracing (debug)", ref tracing))
        {
